...
class ErrorMsgRepository
{
    public static $errors = [
        ...
        -1551  => 'برگشت تراکنش قبلا اًنجام شده است',
        ...
        10  => 'تراکنش با مبلغی پایین تر از مبلغ درخواستی پذیرفته شده است (کمبود حساب مشتری)',
        ...
        21  => 'در صورتی که پاسخ به در خواست ترمینال نیازمند هیچ پاسخ خاص یا عملکردي نباشیم این پیام را خواهیم داشت',
        ...
        57  => 'انجام تراکنش مربوطه توسط دارنده ي کارت مجاز نمی باشد',
        ...
        91  => 'سیستم صدور مجوز انجام تراکنش موقتا غیر فعال است و یا زمان تعیین شده براي صدور مجوز به پایان رسیده است',
